...
<p align="center">
  <img src="https://github.com/nollafox/six2one/blob/main/docs/flowchart.png" alt="six2one flowchart" style="border-radius: 16px; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.12); max-width: 100%; height: auto;">
</p>
