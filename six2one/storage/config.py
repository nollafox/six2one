...
class StoreConfig:
    ...
    def __post_init__(self) -> None:
        ...
        if self.index_dir is not None:
            object.__setattr__(self, "index_dir", self.index_dir.expanduser())
    ...
    def from_path(cls, path: str | Path, *, read_only: bool = False) -> "StoreConfig":
        ...
        index_dir = resolved.parent / "index"
        return cls(path=resolved, index_dir=index_dir, read_only=read_only)
